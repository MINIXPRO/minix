...
# def extract_text_from_pdf(data, method, doc):
#     pdf_path = doc.file_name #data.get("file_name")
#     print("*******************************",pdf_path)
#     print("PDF Path:", pdf_path)  # Debugging output
#     if not os.path.exists(pdf_path):
#         print("Error: File does not exist at the specified location.")
#         #return
